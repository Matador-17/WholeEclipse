...
public class AddEmployeeSteps extends CommonMethods {
	...
	public void i_see_Employee_has_been_succesfully_added() {
		...
		Assert.assertEquals("Employee is NOT being added", pdetails.empId.getText(), pdetails.empId);
	}
	...
	public void modifyEmployeeDetails(DataTable modifyEmpDetail) throws InterruptedException {
		...
		for (Map<String, String> map : modifyList) {
			// click on edit
			click(pdetails.edit_saveBtn);
			// passing info into Personal Details page
			...
			clickRadioBtn(pdetails.genderLabels, map.get("Gender"));
			Thread.sleep(5000);
