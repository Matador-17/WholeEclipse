...
public class CommonMethods extends PageInitializer {
	...
	public static byte[] takeScreenshot(String fileName) {
		...
		// creates picture in the form of byte--> we need it to attach it to pir
		// scenario
		byte[] picture = ts.getScreenshotAs(OutputType.BYTES);

		// taking pictures in a form of tile and store it in the specified location
		Date date = new Date();
	 ...
	 * @param radioText
	 */
	public static void clickRadioBtn(List<WebElement> elements, String radioText) {
